...
class PPOImitation(pposgd_simple.PPO1):
    ...
    def learn(self, total_timesteps, callback=None, log_interval=100, tb_log_name="PPO1",
              reset_num_timesteps=True, save_path=None, save_iters=20, use_curriculum=True):
        ...
        with SetVerbosity(self.verbose), TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name, new_tb_log) \
            ...
            with self.sess.as_default():
                ...
                while True:
                    ...
                    if use_curriculum:
                        curriculum_scale = min(float(timesteps_so_far) / total_timesteps, 1.0)
                        self.env.set_curriculum_scale(curriculum_scale)
...
name_list = ["velocity_reward", "energy_penalty", "pose_reward", "height_reward", "deviation_penalty", "joint_angle_penalty"]
